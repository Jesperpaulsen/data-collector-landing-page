...
const checkIfAuthorized = async (slug: string) => {
  if (slug === '/') return true
...
const checkIfSlugIsKnown = (slug: string) => {
  const globalSlugs = [
    'about',
    'investments',
    'investements',
...
const checkIfPreviewSlugExists = (slug: string) => {
...
const preview = async (req: NextApiRequest, res: NextApiResponse) => {
  ...
  const isAuthorized = await checkIfAuthorized(req.query.slug as string)
